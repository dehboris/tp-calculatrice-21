...
public class MainFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        View.OnClickListener clickHandlerNumber = view1 -> {
            ...
            fullNumber = fullNumber.replaceFirst("^0+(?!$)", "");
        ...
        View.OnClickListener clickHandlerCalculate = view3 -> {
            ...
            switch(methodName){
                ...
                case "div":
                    ...
                    break;
                case "sum":
                    result = Operations.somme(num1, num2);
                    break;
                default:
        ...
        //écoute évenement click sur boutton
        ...
        //écoute évenement click sur Opérateur
